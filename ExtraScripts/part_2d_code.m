...
% Plot current J(x,y)
subplot(2,2,count);
sgtitle('Current J(x,y) vs. Sigma Investigation');
quiver(current_x, current_y)
title(['Box 1 Sigma = ', num2str(boxes{1}.sigma), ', Box 2 Sigma = ', num2str(boxes{2}.sigma)]);
xlabel('x'); ylabel('y');
xlim([0 nx]); ylim([0 ny]);
